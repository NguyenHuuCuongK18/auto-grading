...
namespace SolutionGrader.UI.Services
{
    ...
    public class TestKitConfigService
    {
        ...
        /// Expected structure:
        /// - Column "TestCase": Test case name (TC1, TC2, etc.)
            ...
            try
            {
                ...
                for (int col = 1; col <= worksheet.LastColumnUsed()?.ColumnNumber(); col++)
                {
                    ...
                    if (cellValue == "MARK" || cellValue == "MAXMARK" || cellValue == "MAX_MARK" || cellValue == "ĐIỂM")
                        markCol = col;
                    else if (cellValue == "TESTCASE" || cellValue == "TC" || cellValue == "TEST_CASE")
                        testCaseCol = col;
                }
                ...
                _logger.LogDebug($"Loaded marks from Header.xlsx: {totalMark}");
            }
            catch (Exception ex)
            {
